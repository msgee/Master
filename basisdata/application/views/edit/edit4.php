...
<p align="center"><form enctype="multipart/form-data" name="form1" method="post" action="<?php echo base_url();?>index.php/home/edit_aksi2/<?php echo $detail['codename'];?>" class="myform">
